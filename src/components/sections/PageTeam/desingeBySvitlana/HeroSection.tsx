    ...
    <section className="pb-[110px] pt-[123px]">
      <div className="container flex gap-[130px]">
        <div className="max-w-[499px]">
          ...
          <p className="text-l">
            Ми об'єднуємо спеціалістів різних напрямків, які разом працюють над
            cоціально важливими проєктами. Наші учасники, замовники і партнери
            розсіяні без перебільшення по всьому світу: від Канади до Криму.
          </p>
        </div>
        <Image
          width={531}
