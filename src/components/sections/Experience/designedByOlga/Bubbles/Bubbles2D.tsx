    ...
    useEffect(() => {
        ...
        for (let i = 0; i < wiggleBlock.length; i++){
            ...
            setTimeout(() => {
                ...
                wiggleBlock[i].classList.add('animate-wiggle', 'opacity-1', `${topCoord}`, `${leftCoord}`);
            }, 5000);
