    ...
    useEffect(() => {
        ...
        for (let i = 0; i < wiggleBlock.length; i++){
            ...
            // setTimeout(() => {
                ...
                // wiggleBlock[i].classList.remove('opacity-100', 'top-[500px]', `${leftCoord}`);
            ...
            setTimeout(() => {
                ...
                // wiggleBlock[i].classList.add('opacity-100', `${topCoord}`);
                // wiggleBlock[i].classList.add('animate-bubble-pop', 'transition-all');
                wiggleBlock[i].classList.remove('top-[500px]', 'opacity-0');
            }, 500);
            setTimeout(() => {
                // wiggleBlock[i].className = '';
                // wiggleBlock[i].className = bubbleStyles;
                
                wiggleBlock[i].classList.add('animate-bubble-pop', 'opacity-100', `${topCoord}`);
            }, 1000);
