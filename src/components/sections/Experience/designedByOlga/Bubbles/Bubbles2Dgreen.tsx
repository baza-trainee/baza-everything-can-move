...
const Bubbles2Dgreen:React.FC = () => {
    ...
    useEffect(() => {
        ...
        for (let i = 0; i < bubbles.length; i++){
            ...
            const bubbleStyles = 'bg-[#c3ff0a] rounded-full w-[100px] h-[100px] 2xl:w-[124px] 2xl:h-[124px] flex flex-col items-center justify-center text-olga-green absolute z-10 ';
            setTimeout(() => {
                bubbles[i].className = '';
                bubbles[i].className = bubbleStyles;
                bubbles[i].classList.add('top-[700px]', `${leftCoord}`, 'opacity-100');
            ...
            setTimeout(() => {
             ...
             bubbles[i].addEventListener('click', () => {
                ...
                setTimeout(() => {                
                    bubbles[i].className = '';
                    bubbles[i].className = bubbleStyles;
                    bubbles[i].classList.remove('top-[700px]', `${leftCoord}`, 'opacity-0');
                    bubbles[i].classList.add( `${topCoord}`, `${leftCoord}`, 'duration-5000', 'transition-all', 'ease-in-out');
                }, 4500);
                ...
                setTimeout(() => {
                   bubbles[i].classList.add( 'opacity-100');
                }, 9000);
            })
  ...
  return (
    <div id='Block2Dgreen' className='absolute bottom-[100px] 2xl:bottom-[50px] h-[546px] lg:h-[466px] 2xl:h-[526px] w-fit px-4 lg:px-6 2xl:px-[120px] '>
        <div className='h-[200px] w-[200px] lg:h-[250px] lg:w-[250px] 2xl:h-[280px] 2xl:w-[280px] absolute left-[110px] -top-[55px] lg:left-[55px] lg:-top-[70px] 2xl:-top-[1px] 2xl:left-[205px] rounded-full opacity-100 bg-radial-gradien z-10 hidden'/>
        <div className='h-[200px] w-[200px] lg:h-[250px] lg:w-[250px] 2xl:h-[280px] 2xl:w-[280px] absolute -left-[20px] top-[260px] lg:left-[325px] lg:top-[5px] 2xl:-top-[15px] 2xl:left-[650px] rounded-full opacity-100 bg-radial-gradien z-10 hidden'/>
        <div className='h-[200px] w-[200px] lg:h-[250px] lg:w-[250px] 2xl:h-[280px] 2xl:w-[280px] absolute top-[220px] left-[130px] lg:left-[325px] lg:top-[262px] 2xl:top-[260px] 2xl:left-[500px] rounded-full opacity-100 bg-radial-gradien z-10 hidden'/>

        <div id={styles.bubbles} data-leftsm='162' data-leftlg='124' data-left2xl='290' data-topsm='1' data-toplg='1' data-top2xl='106' className='bg-[#c3ff0a] rounded-full w-[100px] h-[100px] 2xl:w-[124px] 2xl:h-[124px] flex flex-col items-center justify-center text-olga-green absolute z-10 opacity-100 left-[162px] top-[1px] lg:left-[124px] lg:top-[1px] 2xl:top-[106px] 2xl:left-[290px]'>
        </div> 
