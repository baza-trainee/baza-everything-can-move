...
export default function HideWires2XL() {
  ...
  return (
    <div className="my-[100px] lg:my-[80px] hidden 2xl:block z-[9999]">
    {/* // <motion.div 
    //   variants={{
    //     static: { y: -100 },
    //     moved: { y: '-475px' },
    ...
    //   className="relative my-[100px] lg:my-[80px] xl:sticky"> */}
        <p className="my-16 bg-olga-btn-menu px-4 py-10 text-sm font-regular leading-[23.4px] lg:px-6 lg:py-8 lg:uppercase xl:py-10 xl:px-[120px] 2xl:px-[130px] 2xl:py-16 2xl:text-l 2xl:leading-[31.2px] z-[9999]">
