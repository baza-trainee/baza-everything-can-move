...
const Bubbles2D:React.FC = () => {
    ...
    useEffect(() => {
        ...
        for (let i = 0; i < wiggleBlock.length; i++){
            ...
            const shadowShownStyles = ['h-[350px] w-[350px] absolute translate-x-[30px] translate-y-[220px] rounded-full opacity-100 bg-radial-gradient z-0 block', 'h-[350px] w-[350px] absolute translate-x-[285px] translate-y-[360px] rounded-full opacity-100 bg-radial-gradient z-0 block', 'h-[350px] w-[350px] absolute translate-x-[450px] translate-y-[50px] rounded-full opacity-100 bg-radial-gradient z-0 block', 'h-[350px] w-[350px] absolute translate-x-[735px] translate-y-[250px] rounded-full opacity-100 bg-radial-gradient z-0 block', 'h-[350px] w-[350px] absolute translate-x-[1000px] translate-y-[250px] rounded-full opacity-100 bg-radial-gradient z-0 block'];
            ...
            wiggleBlock[i].addEventListener('mouseenter', () => {
             ...
             wiggleBlock[i].addEventListener('click', () => {
                if(!Block2D){ return }
                 setTimeout(() => 
                 {
                    wiggleBlock[i].className += ' hidden';
  ...
  return (
    <div id='Block2D' className='absolute top-0 left-0 right-0 bottom-0 w-full'>
        ...
        <div className='h-[350px] w-[350px] absolute translate-x-[1000px] translate-y-[250px] rounded-full opacity-100 bg-radial-gradient z-0 hidden'/>
         <div id={styles.wiggleBlock} data-left='120' data-top='312' className='bg-[#1D1D1C] rounded-full w-[164px] h-[164px] flex flex-col items-center justify-center text-olga-green duration-400 absolute top-[312px] left-[120px] z-10'>
        ...
        <div id={styles.wiggleBlock} data-left='379' data-top='449' className='bg-[#1D1D1C] rounded-full w-[164px] h-[164px] flex flex-col items-center justify-center text-olga-green duration-400 absolute top-[449px] left-[379px] z-10'>
        ...
        <div id={styles.wiggleBlock} data-left='534' data-top='129' className='bg-[#1D1D1C] rounded-full w-[164px] h-[164px] flex flex-col items-center justify-center text-olga-green duration-400 absolute top-[129px] left-[534px] z-10'>
            <div className="text-xl leading-[72px] font-medium">{'102+'}</div>
            <div className="text-s leading-[21px] font-regular">{'працевлаштовано'}</div>
        </div>
        <div id={styles.wiggleBlock} data-left='828' data-top='346' className='bg-[#1D1D1C] rounded-full w-[164px] h-[164px] flex flex-col items-center justify-center text-olga-green duration-400 absolute top-[346px] left-[828px] z-10'>
            <div className="text-xl leading-[72px] font-medium">{'14+'}</div>
            <div className="text-s leading-[21px] font-regular">{'технологій'}</div>
        </div>
        <div id={styles.wiggleBlock} data-left='1094' data-top='339' className='bg-[#1D1D1C] rounded-full w-[164px] h-[164px] flex flex-col items-center justify-center text-olga-green duration-400 absolute top-[339px] left-[1094px] z-10'>
