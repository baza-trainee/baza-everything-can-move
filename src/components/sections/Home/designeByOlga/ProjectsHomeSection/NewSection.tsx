...
const NewSection: React.FC = () => {
  ...
  return (
    <section ref={containerRef} className="pb-[100px] 2xl:pb-[120px]">
          ...
          <div className="lg:relative lg:block lg:h-[338px] lg:w-[620px]">
            {IMAGES_HOME_PROJECTS.map((image, ind) => (
              ...
              <div
                ...
                className="relative h-[190px] w-[340px] rounded-sm border border-white bg-olga-green text-olga-grey"
              >
