...
const TechCard: React.FC<TechCardProp> = ({ oneStack }) => {
  return (
    <div className="flex h-[200px] w-[220px] flex-col rounded-2xl border border-white bg-black font-second-family text-l font-medium leading-o-120 tracking-s-2 text-white 2xl:text-md">
