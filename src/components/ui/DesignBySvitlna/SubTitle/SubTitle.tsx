...
export function SubTitle({
  ...
  return (
    <div
      className={cn(
        'relative h-[34px] w-[126px] border-[1px] border-solid border-white lg:h-[58px] lg:w-[216px]',
        className
      )}
    >
      ...
      <Cover className="let flex items-center justify-center font-second-family text-md font-medium uppercase leading-s-100 tracking-custom-tight lg:text-lg lg:leading-o-120">
        {text}
      </Cover>
    </div>
  );
