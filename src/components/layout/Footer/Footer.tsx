...
const Footer: React.FC = () => {
  ...
  return (
    <>
      {designType !== 'initial' && (
        <footer className="z-[9000] bg-black">
          <div
            className={clsx(
          ...
          >
            ...
            >
              <Link
                ...
                className={clsx(
                  designType === 'designBySvitlana' &&
                    'h-[74px] w-[74px] lg:h-[60px] lg:w-[60px] 2xl:h-[84px] 2xl:w-[84px]',
                  designType === 'designByOlga' && 'h-[80px] w-[80px]'
                )}
              >
                <Image
              ...
              >
                ...
                >
                  ...
                  <a
                    className={clsx(
                      designType === 'designByOlga' && 'lg:w-[245px] xl:w-auto',
                      designType === 'designBySvitlana' &&
                        'lg:w-[212px] xl:w-auto'
                    )}
              ...
              >
                <li
                  className={clsx(
                    'w-[50%] py-2 hover:text-s-light-purple',
                    designType === 'designByOlga' && 'hidden',
                    designType === 'designBySvitlana' && 'lg:hidden'
                  )}
                >
              ...
              {SocialMediaData.map((social) => {
                return (
                  ...
                  >
                    <Link
                      className={clsx(
                        designType === 'designBySvitlana' && 'text-m 2xl:text-l'
                      )}
                      href={social.link}
                    >
                      {social.name}
