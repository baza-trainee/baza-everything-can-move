          ...
          >
            ...
            <div
              ...
              className={clsx(
                ...
                designType === 'designBySvitlana' &&
                  'h-16 w-[107px] bg-s-gray pl-[27px] pt-6 hover:bg-s-purple hover:text-olga-bg lg:h-[100px] lg:w-[180px] lg:pb-4 lg:pl-4 lg:pr-6 lg:pt-6 2xl:h-[107px] 2xl:w-[297px] 2xl:pb-3 2xl:pl-5 2xl:pr-20 2xl:pt-8'
              )}
            >
              <ICONS_SRC.OPEN_MENU_ICON
                className={clsx(
                  ...
                  designType === 'designBySvitlana' &&
                    'hover:fill-black lg:mb-6 2xl:mb-[26px]'
                )}
              />
